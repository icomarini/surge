...
//     PipelineID createPipeline(const core::shader::Type shaderType, const DescriptorSetLayouts...
...
//             core::createPipelineLayout(command.context, push, mainCamera.descriptorSetLayout,
//             descriptorSetLayouts...);
